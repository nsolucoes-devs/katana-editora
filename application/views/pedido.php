                            ...
                            <table class="table">
                                <thead>
                                    <tr style="background-color: #afd4fa;">
                                        <th style="width: 15%; color: #0b193c;" scope="col">Data/hora</th>
                                        <th class="text-center" style="width: 50%; color: #0b193c;" scope="col">Histórico</th>
                                        <th style="width: 15%; color: #0b193c;" class="text-center" scope="col">Situação</th>
                                    </tr>
                                </thead>
                                <tbody>
