...
<head>
    <!-- meta descrição -->
    <title>Katana Editora</title>
    <meta name="title" content="Katana Editora">
    <meta name="author" content="N Soluções Agência Digital - https://nsolucoes.digital/" />
    <meta name="description" content="Katana Editora" />
    <meta name="keywords" content="Katana Editora" />


    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?php echo base_url() ?>imagens/logo/icon2.png" />
    <!--===============================================================================================-->
    ...
    <style>
        :root {
            ...
            --hue2: 335;
            /* HSL color mode */
            --base-color: hsl(var(--hue) 0% 15%);
            --base-color-second: hsl(var(--hue) 0% 90%);
    ...
    <style>
        ...
        /*.header-sticky.sticky-bar {background: #0b193c;}*/
        li {
            list-style: none;
        }
...
<?php if (isset($boleto)) { ?>
    ...
    <?php } else { ?>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-dark fixed-top menu-transparente">
                        ...
                        <div class="col-6 text-center px-5">
                            <form id="buscador" action="<?php echo base_url('servico/buscaServicos'); ?>" method="post">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Pesquise aqui" aria-label="Pesquise aqui" aria-describedby="button-addon2">
                            ...
                            <div class="align-items-center row">
                                ...
                                <div class="col-md-2 text-center">
                                    <a href="<?php echo base_url('') ?>">
                                        <img class="logo-img" style="z-index: 40;" src="<?php echo base_url('imagens/logo/l3.png') ?>" alt="logo" title="DataCom Notebook e Informática">
                                    </a>
                                </div>
                                        ...
                                        <div class="d-lg-block f-right main-menu d-none text-right" style="width: 100%">
                                            <nav style="display: -webkit-box;">
                                                <ul class="nav-main-top mg-left" style="width: 57%; margin-left: 11%; margin-right: -6%;">
                                                    <li class="text-center" style="width: 75%;position: relative;top: 23%;">
                                                        <form id="buscador" action="<?php echo base_url('servico/buscaServicos'); ?>" method="post">
                                                            <input style="font-weight: 500; height: 35px;" name="busca" id="search_produto" type="text" class="form-control" placeholder="Pesquise por aqui" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                            <a class="btn btn-primary lupa-bt" style="position: relative;top: -35px;left: 46.5%;height: 35px;background-color: #bdbdbd;border-color: #bdbdbd;" onclick="searchTrigger()"><i style="cursor: pointer;color: var(--base-color);font-size: 25px;" class="fa fa-search" aria-hidden="true"></i></a>
                                                        </form>
                                                    </li>
                                                </ul>
                                                ...
                                                <a class="menu-link menu-a" href="<?php //echo base_url('2b1e190210df261675c4b801bc6e8989') 
                                                        ...
                                                        <li class="menu-li" style="position: relative;top: 20px;left: 80px; margin-left: 30px;">
                                                            <span class="menu-a" href="#">
                                                                <span style="font-size: 15px;">
                                                                    <i style="font-size: 30px; color: #bdbdbd;" class="fa fa-user-circle"></i>
                                                                    <span>&nbsp Faça <a style="font-weight: 500; color:white;" href="<?php echo base_url('2b1e190210df261675c4b801bc6e8989') ?>">Login</a>
                                                                        ou <br>
                                                                        <ul style="padding-left: 67px;">
                                                                            crie seu <a style="font-weight: 500; color:white;" href="<?php echo base_url('2b1e190210df261675c4b801bc6e8989') ?>">Cadastro</a>
                                                                        </ul>
                                                                    </span>
                                                                </span>
                                                            </span>
                                                    ...
                                                    <?php if (isset($_SESSION['perfil']) && isset($_SESSION) && $_SESSION['perfil'] != 'afiliado') { ?>
                                                        <li class="menu-li" style="position: relative;top: 20px;left: 110px;">
                                                            <a class="menu-link menu-a" <?= $idpag == 5 ? 'style="color: #f9c716"' : '' ?> href="<?php echo base_url('432b311230a5e558d6dfdd37aa7cb986'); ?>">
                                                                <i <?= !$mobile_view ? "id='span'" : '' ?> style="font-size: 30px; color: #bdbdbd;" class="fa fa-shopping-cart" aria-hidden="true"></i>
                                                                <?php if ($this->session->userdata('quantidade_carrinho')) {
                                                                    if ($this->session->userdata('quantidade_carrinho') > 0) { ?>
            ...
            <?php if ($mobile_view == 1) { ?>
                <div class="header-area header-transparent pt-20 menu-transparente" tyle="z-index:99; position:fixed; width:100%; background: var(--base-color);">
                    <!-- background: -webkit-linear-gradient(bottom, #082b3d, #0b193c, #361c25, #4c201c); box-shadow: rgb(0 0 0 / 15%) 1.95px 1.95px 2.6px; -->
                    <div class="header-sticky main-header" <?php if (!$mobile_view) { ?>style="height: 100%; padding: 10px 30px;" <?php } ?>>

                        <div class="container-fluid" style="">
                            <!--background: -webkit-linear-gradient(bottom, #082b3d, #0b193c, #4c1d1c, #4e3721);-->
                            <div class="align-items-center row">
                                <div class="col-12">
                                        ...
                                        <div class="row" style="margin-bottom: -5%;">
                                            ...
                                            <div class="col-6 text-right usuario-mobile" style="position: relative; right: 0; top: 0; padding: 5% 10%;">
                                                <a class="menu-link menu-a user-icon-pos" href="<?php echo base_url('2b1e190210df261675c4b801bc6e8989') ?>" style="<?php if ($idpag == 6) {
                                                    ...
                                                    <i style="color: #bdbdbd; font-size: 30px" class="fa fa-user-circle" aria-hidden="true"></i>
                                                </a>
                                                <?php if (isset($_SESSION['perfil']) && isset($_SESSION) && $_SESSION['perfil'] != 'afiliado') { ?>
                                                    <a href="<?php echo base_url('432b311230a5e558d6dfdd37aa7cb986'); ?>" class="menu-link menu-a cart-icon-pos" style="<?php if ($idpag == 5) {
                                                                                                                                                                            echo 'color: #f9c716;';
                                                                                                                                                                        } ?>">
                                                        <i style="color: #bdbdbd; font-size: 25px" class="fa fa-shopping-cart" aria-hidden="true"></i>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <!-- <div class="col-2 botaoNav">
                                                <button class="navbar-toggler d-block" style="width: 60%; height: 50%; margin-top: 80%; margin-left: 30%;" type="button" id="navToggleMobile">
                                                    <i class="fas fa-bars" onclick="mySideBar()" style="color: #bdbdbd; position: relative; left: -9px;"></i>
                                                </button>
                                            </div> -->
                                            <div class="col-10 search-div">
                                                <form id="buscador" action="<?php echo base_url('servico/buscaServicos'); ?>" method="post">
                                                    <div class="text-center input-group" style="margin-top: 6%; position: relative;">
                                ...
                                <li class="menu-li">
                                    ...
                                    <?php if ($this->session->userdata('cliente_logado') == 1) { ?>
                                        <a href="<?php echo base_url('c8b39540f80ad8d4952cf79d651aec77'); ?>" class="menu-link menu-a" style="margin: 5%;<?php if ($idpag == 5) {
                                            ...
                                            <i style="color: #bdbdbd; font-size: 20px" class="fas fa-sign-out-alt" aria-hidden="true"></i>
                                        </a>
                                    <?php } ?>
                                </li>
                            <?php } ?>
