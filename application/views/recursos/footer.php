...
<div class="row new-cookie" id="new-cookie" style="display: none">
    <div class="cookie-pc col-md-12">
        <div class="row">
            <div class="col-md-10">
                <p class="frase" style="margin-top: 18px;">Ao clicar em "Aceitar", você concorda com o armazenamento de cookies em seu dispositivo. Para mais detalhes, leia nossa <span data-toggle="modal" data-target="#privacidade" style="color: red; cursor: pointer">Política de Privacidade</span>.</p>
            </div>
            <div class="col-md-2">
                <a href='https://www.google.com.br'><button type="button" class="btn btn-primary button-style offset-md-12" style="margin-left: 100%;">X</button></a>
                <button type="button" class="btn btn-primary" onclick="acceptCookie()" style="margin: 10px; height: auto; padding: 4px; margin-left: 5%;">Aceitar</button>
            </div>
        </div>
    </div>
    ...
    <div class="cookie-mob col-md-12">
        <div class="row">
            ...
            <div class="col-md-2 text-center" style="margin-bottom: 10px">
                <button type="button" class="btn btn-primary button-style offset-md-12" onclick="closeCookie()" style="margin-left: 100%;">X</button>
                <button type="button" class="btn btn-primary" onclick="acceptCookie()" style="height: auto; padding: 4px;">Aceitar</button>
            </div>
        </div>
    </div>
</div>
...
<footer <?php if ($mobile_view == 1) { ?>style="margin-bottom: -5%;" <?php } ?>>
    <!-- Footer Start-->
    <div id="footer-pc" style="background: var(--base-color); width: 100%; padding-top: 5%;">
        <div class="row">
            <div class="col-md-2 text-center">
                <div class="row">
                    <a href="<?php echo base_url() ?>" style="position: relative; top: -22px;">
                        <img src="<?php echo base_url('imagens/logo/l3.png') ?>" style="width: 90%; margin-bottom: auto; margin-left: auto;">
                    </a>
                </div>
                
            </div>
                <div class="col-md-4">
                    <div class="endereco-ipad">
                        <ul>
                            <li style="color: white; font-size: 14px; list-style-type: none; font-weight:bold; padding-bottom: 7px;">Katana Editora
                            </li>
                            <li style="color: white; font-size: 14px; list-style-type: none; padding-bottom: 7px;"><i class="fa fa-phone-alt text-primary me-2" style="color: #bdbdbd !important;"></i> (31) 98208-0107
                            </li>
                            <li style="color: white; font-size: 14px; list-style-type: none; padding-bottom: 7px;"><i class="fas fa-map-marker-alt text-primary me-2" style="color: #bdbdbd !important;"></i>&nbsp Rua dos Pica-Paus, 160 - Belo Horizonte - MG
                            </li>
        ...
        <div class="copyright">
            <div style="font-size: 12px; color:grey;" class="row">
                ...
                <div class="col-md-4 text-center mb-3 mb-md-0">
                    <p style="color: white; font-size: 11px;">© Katana Editora, todos os direitos reservados. </p>
    ...
    <?php if ($mobile_view == 1) { ?>
        <!-- Footer mobile -->
        <div id="footer-mob" class="row w-100  text-center mx-auto" style="background: var(--base-color); margin: 0%; background: var(--base-color); overflow-x: hidden;">
            <!--b37000-->
            <div>
                ...
                <div class="text-center form-group div-social" style="">
                    ...
                    <a href="https://www.instagram.com/katanaeditora" class="espacamento-icone" target="_blank">
                        <i class="social-footer fab fa-instagram" aria-hidden="true" style="color: #bdbdbd; position: relative !important"></i>
                    </a>
                ...
                <div class="text-center" style="margin-right: 6%;">
                    <img src="<?php echo base_url('imagens/logo/l3.png') ?>" class="formas-pagamento-ipad" style="width: 99%; text-align: center; z-index: 101; margin: -15% 4% 0% 4%;">
                </div>
